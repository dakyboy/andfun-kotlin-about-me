...
class MainActivity : AppCompatActivity() {
    ...
    // (03) Create a binding object in the MainActivity.

    private lateinit var binding: ActivityMainBinding

    // (09) Create an instance of MyName and set binding.myName to it.
    private val myName: MyName = MyName("Edaku Aaron")

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        // (04) Use DataBindingUtil to set the layout for MainActivity.

        binding = DataBindingUtil.setContentView(this, R.layout.activity_main)

        // TODO Use the binding object to replace all calls to findViewById.
    ...
    private fun addNickname(view: View) {
        // (10) set the nickname in the binding object and invalidateAll().
